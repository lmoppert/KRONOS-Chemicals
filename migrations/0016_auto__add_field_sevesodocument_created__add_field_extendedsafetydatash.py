...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SevesoDocument.created'
        db.add_column(u'chemicals_sevesodocument', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ExtendedSafetyDataSheet.created'
        db.add_column(u'chemicals_extendedsafetydatasheet', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'SafetyDataSheet.created'
        db.add_column(u'chemicals_safetydatasheet', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ReachDocument.created'
        db.add_column(u'chemicals_reachdocument', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Document.created'
        db.add_column(u'chemicals_document', 'created',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.datetime(2014, 2, 24, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SevesoDocument.created'
        db.delete_column(u'chemicals_sevesodocument', 'created')

        # Deleting field 'ExtendedSafetyDataSheet.created'
        db.delete_column(u'chemicals_extendedsafetydatasheet', 'created')

        # Deleting field 'SafetyDataSheet.created'
        db.delete_column(u'chemicals_safetydatasheet', 'created')

        # Deleting field 'ReachDocument.created'
        db.delete_column(u'chemicals_reachdocument', 'created')

        # Deleting field 'Document.created'
        db.delete_column(u'chemicals_document', 'created')
