...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RiskIndication'
        db.create_table(u'chemicals_riskindication', (
        ...
        db.send_create_signal('chemicals', ['RiskIndication'])

        # Removing M2M table for field risks on 'Chemical'
        db.delete_table(db.shorten_name(u'chemicals_chemical_risks'))

        # Deleting field 'Risk.name_de'
        db.delete_column(u'chemicals_risk', 'name_de')

        # Deleting field 'Risk.name'
        db.delete_column(u'chemicals_risk', 'name')

        # Deleting field 'Risk.name_en'
        db.delete_column(u'chemicals_risk', 'name_en')

        # Deleting field 'Risk.name_nb'
        db.delete_column(u'chemicals_risk', 'name_nb')

        # Deleting field 'Risk.name_nl'
        db.delete_column(u'chemicals_risk', 'name_nl')

        # Adding field 'Risk.chemical'
        db.add_column(u'chemicals_risk', 'chemical',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chemicals.Chemical']),
                      keep_default=False)

        # Adding field 'Risk.riskindication'
        db.add_column(u'chemicals_risk', 'riskindication',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['chemicals.RiskIndication']),
                      keep_default=False)

        # Adding field 'Risk.info_en'
        db.add_column(u'chemicals_risk', 'info_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Risk.info_de'
        db.add_column(u'chemicals_risk', 'info_de',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Risk.info_nl'
        db.add_column(u'chemicals_risk', 'info_nl',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Risk.info_nb'
        db.add_column(u'chemicals_risk', 'info_nb',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RiskIndication'
        db.delete_table(u'chemicals_riskindication')
        ...
        # Adding field 'Risk.name_de'
        db.add_column(u'chemicals_risk', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Risk.name'
        db.add_column(u'chemicals_risk', 'name',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Risk.name_en'
        db.add_column(u'chemicals_risk', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Risk.name_nb'
        db.add_column(u'chemicals_risk', 'name_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Risk.name_nl'
        db.add_column(u'chemicals_risk', 'name_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Risk.chemical'
        db.delete_column(u'chemicals_risk', 'chemical_id')

        # Deleting field 'Risk.riskindication'
        db.delete_column(u'chemicals_risk', 'riskindication_id')

        # Deleting field 'Risk.info_en'
        db.delete_column(u'chemicals_risk', 'info_en')

        # Deleting field 'Risk.info_de'
        db.delete_column(u'chemicals_risk', 'info_de')

        # Deleting field 'Risk.info_nl'
        db.delete_column(u'chemicals_risk', 'info_nl')

        # Deleting field 'Risk.info_nb'
        db.delete_column(u'chemicals_risk', 'info_nb')
