...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.info'
        db.alter_column(u'chemicals_contact', 'info', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Contact.web'
        db.alter_column(u'chemicals_contact', 'web', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Contact.fax'
        db.alter_column(u'chemicals_contact', 'fax', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Contact.country'
        db.alter_column(u'chemicals_contact', 'country', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Contact.phone'
        db.alter_column(u'chemicals_contact', 'phone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Contact.address'
        db.alter_column(u'chemicals_contact', 'address', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Contact.email'
        db.alter_column(u'chemicals_contact', 'email', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Contact.info'
        db.alter_column(u'chemicals_contact', 'info', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Contact.web'
        db.alter_column(u'chemicals_contact', 'web', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Contact.fax'
        db.alter_column(u'chemicals_contact', 'fax', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Contact.country'
        db.alter_column(u'chemicals_contact', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Contact.phone'
        db.alter_column(u'chemicals_contact', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Contact.address'
        db.alter_column(u'chemicals_contact', 'address', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Contact.email'
        db.alter_column(u'chemicals_contact', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
