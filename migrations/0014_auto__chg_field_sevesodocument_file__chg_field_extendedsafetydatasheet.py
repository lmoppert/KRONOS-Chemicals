...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SevesoDocument.file'
        db.alter_column(u'chemicals_sevesodocument', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))

        # Changing field 'ExtendedSafetyDataSheet.file'
        db.alter_column(u'chemicals_extendedsafetydatasheet', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))

        # Changing field 'SafetyDataSheet.file'
        db.alter_column(u'chemicals_safetydatasheet', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))

        # Changing field 'Pictogram.image'
        db.alter_column(u'chemicals_pictogram', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True))

        # Changing field 'ReachDocument.file'
        db.alter_column(u'chemicals_reachdocument', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))

        # Changing field 'Document.file'
        db.alter_column(u'chemicals_document', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SevesoDocument.file'
        raise RuntimeError("Cannot reverse this migration. 'SevesoDocument.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SevesoDocument.file'
        db.alter_column(u'chemicals_sevesodocument', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))

        # User chose to not deal with backwards NULL issues for 'ExtendedSafetyDataSheet.file'
        raise RuntimeError("Cannot reverse this migration. 'ExtendedSafetyDataSheet.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ExtendedSafetyDataSheet.file'
        db.alter_column(u'chemicals_extendedsafetydatasheet', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))

        # User chose to not deal with backwards NULL issues for 'SafetyDataSheet.file'
        raise RuntimeError("Cannot reverse this migration. 'SafetyDataSheet.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'SafetyDataSheet.file'
        db.alter_column(u'chemicals_safetydatasheet', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))

        # User chose to not deal with backwards NULL issues for 'Pictogram.image'
        raise RuntimeError("Cannot reverse this migration. 'Pictogram.image' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Pictogram.image'
        db.alter_column(u'chemicals_pictogram', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image']))

        # User chose to not deal with backwards NULL issues for 'ReachDocument.file'
        raise RuntimeError("Cannot reverse this migration. 'ReachDocument.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ReachDocument.file'
        db.alter_column(u'chemicals_reachdocument', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))

        # User chose to not deal with backwards NULL issues for 'Document.file'
        raise RuntimeError("Cannot reverse this migration. 'Document.file' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Document.file'
        db.alter_column(u'chemicals_document', 'file_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.File']))
    ...
    models = {
        ...
        'chemicals.chemical': {
            ...
            'wgk': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chemicals.WGK']", 'null': 'True', 'blank': 'True'})
        },
        'chemicals.contact': {
        ...
        'chemicals.person': {
            ...
            'academic_title': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'fax': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'chemicals.stock': {
            ...
            'max_volume': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'year_unit': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            'year_volume': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'})
        },
