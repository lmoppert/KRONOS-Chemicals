...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WGK.name_nb'
        db.delete_column(u'chemicals_wgk', 'name_nb')

        # Deleting field 'WGK.name_de'
        db.delete_column(u'chemicals_wgk', 'name_de')

        # Deleting field 'WGK.name_en'
        db.delete_column(u'chemicals_wgk', 'name_en')

        # Deleting field 'WGK.name_nl'
        db.delete_column(u'chemicals_wgk', 'name_nl')

        # Adding field 'WGK.description'
        db.add_column(u'chemicals_wgk', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WGK.description_en'
        db.add_column(u'chemicals_wgk', 'description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WGK.description_de'
        db.add_column(u'chemicals_wgk', 'description_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WGK.description_nl'
        db.add_column(u'chemicals_wgk', 'description_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WGK.description_nb'
        db.add_column(u'chemicals_wgk', 'description_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'WGK.name'
        db.alter_column(u'chemicals_wgk', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):
        # Adding field 'WGK.name_nb'
        db.add_column(u'chemicals_wgk', 'name_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WGK.name_de'
        db.add_column(u'chemicals_wgk', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WGK.name_en'
        db.add_column(u'chemicals_wgk', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'WGK.name_nl'
        db.add_column(u'chemicals_wgk', 'name_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'WGK.description'
        db.delete_column(u'chemicals_wgk', 'description')

        # Deleting field 'WGK.description_en'
        db.delete_column(u'chemicals_wgk', 'description_en')

        # Deleting field 'WGK.description_de'
        db.delete_column(u'chemicals_wgk', 'description_de')

        # Deleting field 'WGK.description_nl'
        db.delete_column(u'chemicals_wgk', 'description_nl')

        # Deleting field 'WGK.description_nb'
        db.delete_column(u'chemicals_wgk', 'description_nb')


        # Changing field 'WGK.name'
        db.alter_column(u'chemicals_wgk', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
