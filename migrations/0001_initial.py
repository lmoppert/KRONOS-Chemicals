    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signal', models.CharField(default=b'n', max_length=1, verbose_name='Signal', choices=[(b'd', 'danger'), (b'w', 'warning'), (b'n', 'no signal')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('doctype', models.CharField(max_length=100, verbose_name='Document Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chemical', models.ForeignKey(verbose_name='Chemical', to='chemicals.Chemical')),
                ('file', filer.fields.file.FilerFileField(verbose_name='File', blank=True, to='filer.File', null=True)),
                ('supplier', models.ForeignKey(verbose_name='Supplier', to='chemicals.Contact')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.ForeignKey(verbose_name='Contact', to='chemicals.Contact')),
