...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HPhraseRelation'
        db.create_table(u'chemicals_hphraserelation', (
        ...
        db.send_create_signal('chemicals', ['HPhraseRelation'])

        # Removing M2M table for field hphrases on 'Chemical'
        db.delete_table(db.shorten_name(u'chemicals_chemical_hphrases'))

        # Deleting field 'HPhrase.info_nb'
        db.delete_column(u'chemicals_hphrase', 'info_nb')

        # Deleting field 'HPhrase.info_nl'
        db.delete_column(u'chemicals_hphrase', 'info_nl')

        # Deleting field 'HPhrase.info_de'
        db.delete_column(u'chemicals_hphrase', 'info_de')

        # Deleting field 'HPhrase.info'
        db.delete_column(u'chemicals_hphrase', 'info')

        # Deleting field 'HPhrase.info_en'
        db.delete_column(u'chemicals_hphrase', 'info_en')


    def backwards(self, orm):
        # Deleting model 'HPhraseRelation'
        db.delete_table(u'chemicals_hphraserelation')
        ...
        # Adding field 'HPhrase.info_nb'
        db.add_column(u'chemicals_hphrase', 'info_nb',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.info_nl'
        db.add_column(u'chemicals_hphrase', 'info_nl',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.info_de'
        db.add_column(u'chemicals_hphrase', 'info_de',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.info'
        db.add_column(u'chemicals_hphrase', 'info',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.info_en'
        db.add_column(u'chemicals_hphrase', 'info_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
