...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chemical.comment'
        db.alter_column(u'chemicals_chemical', 'comment', self.gf('django.db.models.fields.CharField')(max_length=800, null=True))

        # Changing field 'Chemical.einecs'
        db.alter_column(u'chemicals_chemical', 'einecs', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Chemical.article'
        db.alter_column(u'chemicals_chemical', 'article', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Chemical.cas'
        db.alter_column(u'chemicals_chemical', 'cas', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Chemical.registration_number'
        db.alter_column(u'chemicals_chemical', 'registration_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Chemical.comment'
        db.alter_column(u'chemicals_chemical', 'comment', self.gf('django.db.models.fields.CharField')(default='', max_length=800))

        # Changing field 'Chemical.einecs'
        db.alter_column(u'chemicals_chemical', 'einecs', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Chemical.article'
        db.alter_column(u'chemicals_chemical', 'article', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Chemical.cas'
        db.alter_column(u'chemicals_chemical', 'cas', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Chemical.registration_number'
        db.alter_column(u'chemicals_chemical', 'registration_number', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
