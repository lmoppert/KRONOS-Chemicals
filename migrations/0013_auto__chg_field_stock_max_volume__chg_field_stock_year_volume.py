...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Stock.max_volume'
        db.alter_column(u'chemicals_stock', 'max_volume', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Stock.year_volume'
        db.alter_column(u'chemicals_stock', 'year_volume', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

    def backwards(self, orm):

        # Changing field 'Stock.max_volume'
        db.alter_column(u'chemicals_stock', 'max_volume', self.gf('django.db.models.fields.CharField')(default='', max_length=25))

        # Changing field 'Stock.year_volume'
        db.alter_column(u'chemicals_stock', 'year_volume', self.gf('django.db.models.fields.CharField')(default='', max_length=25))
