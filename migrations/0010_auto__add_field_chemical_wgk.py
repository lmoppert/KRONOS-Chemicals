...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Chemical.wgk'
        db.add_column(u'chemicals_chemical', 'wgk',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chemicals.WGK'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Chemical.wgk'
        db.delete_column(u'chemicals_chemical', 'wgk_id')
