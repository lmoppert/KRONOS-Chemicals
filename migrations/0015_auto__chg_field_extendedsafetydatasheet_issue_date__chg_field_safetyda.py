...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExtendedSafetyDataSheet.issue_date'
        db.alter_column(u'chemicals_extendedsafetydatasheet', 'issue_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'SafetyDataSheet.issue_date'
        db.alter_column(u'chemicals_safetydatasheet', 'issue_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExtendedSafetyDataSheet.issue_date'
        db.alter_column(u'chemicals_extendedsafetydatasheet', 'issue_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 10, 0, 0)))

        # Changing field 'SafetyDataSheet.issue_date'
        db.alter_column(u'chemicals_safetydatasheet', 'issue_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 2, 10, 0, 0)))
