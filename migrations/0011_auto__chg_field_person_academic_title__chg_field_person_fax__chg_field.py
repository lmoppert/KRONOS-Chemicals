...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.academic_title'
        db.alter_column(u'chemicals_person', 'academic_title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.fax'
        db.alter_column(u'chemicals_person', 'fax', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.surname'
        db.alter_column(u'chemicals_person', 'surname', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.title'
        db.alter_column(u'chemicals_person', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.phone'
        db.alter_column(u'chemicals_person', 'phone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Person.email'
        db.alter_column(u'chemicals_person', 'email', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Person.academic_title'
        db.alter_column(u'chemicals_person', 'academic_title', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Person.fax'
        db.alter_column(u'chemicals_person', 'fax', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Person.surname'
        db.alter_column(u'chemicals_person', 'surname', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Person.title'
        db.alter_column(u'chemicals_person', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Person.phone'
        db.alter_column(u'chemicals_person', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'Person.email'
        db.alter_column(u'chemicals_person', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
