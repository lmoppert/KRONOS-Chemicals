...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StorageClass.classification'
        db.alter_column(u'chemicals_storageclass', 'classification', self.gf('django.db.models.fields.CharField')(max_length=40))

        # Rename field 'StorageClass.classification' to 'StorageClass.name'
        db.rename_column(u'chemicals_storageclass', 'classification', 'name')


    def backwards(self, orm):

        # Rename field 'StorageClass.classification' to 'StorageClass.name'
        db.rename_column(u'chemicals_storageclass', 'name', 'classification')

        # Changing field 'StorageClass.classification'
        db.alter_column(u'chemicals_storageclass', 'classification', self.gf('django.db.models.fields.CharField')(max_length=100))
