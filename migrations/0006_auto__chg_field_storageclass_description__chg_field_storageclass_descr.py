...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StorageClass.description'
        db.alter_column(u'chemicals_storageclass', 'description', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'StorageClass.description_en'
        db.alter_column(u'chemicals_storageclass', 'description_en', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'StorageClass.description_nl'
        db.alter_column(u'chemicals_storageclass', 'description_nl', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'StorageClass.description_de'
        db.alter_column(u'chemicals_storageclass', 'description_de', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

        # Changing field 'StorageClass.description_nb'
        db.alter_column(u'chemicals_storageclass', 'description_nb', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'StorageClass.description'
        db.alter_column(u'chemicals_storageclass', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'StorageClass.description_en'
        db.alter_column(u'chemicals_storageclass', 'description_en', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'StorageClass.description_nl'
        db.alter_column(u'chemicals_storageclass', 'description_nl', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'StorageClass.description_de'
        db.alter_column(u'chemicals_storageclass', 'description_de', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'StorageClass.description_nb'
        db.alter_column(u'chemicals_storageclass', 'description_nb', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
