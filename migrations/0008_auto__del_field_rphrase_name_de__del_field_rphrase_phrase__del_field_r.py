...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RPhrase.name_de'
        db.delete_column(u'chemicals_rphrase', 'name_de')

        # Deleting field 'RPhrase.phrase'
        db.delete_column(u'chemicals_rphrase', 'phrase')

        # Deleting field 'RPhrase.name_en'
        db.delete_column(u'chemicals_rphrase', 'name_en')

        # Deleting field 'RPhrase.name_nb'
        db.delete_column(u'chemicals_rphrase', 'name_nb')

        # Deleting field 'RPhrase.name_nl'
        db.delete_column(u'chemicals_rphrase', 'name_nl')

        # Adding field 'RPhrase.description'
        db.add_column(u'chemicals_rphrase', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RPhrase.description_en'
        db.add_column(u'chemicals_rphrase', 'description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RPhrase.description_de'
        db.add_column(u'chemicals_rphrase', 'description_de',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RPhrase.description_nl'
        db.add_column(u'chemicals_rphrase', 'description_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RPhrase.description_nb'
        db.add_column(u'chemicals_rphrase', 'description_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HPhrase.name_de'
        db.delete_column(u'chemicals_hphrase', 'name_de')

        # Deleting field 'HPhrase.phrase'
        db.delete_column(u'chemicals_hphrase', 'phrase')

        # Deleting field 'HPhrase.name_en'
        db.delete_column(u'chemicals_hphrase', 'name_en')

        # Deleting field 'HPhrase.name_nb'
        db.delete_column(u'chemicals_hphrase', 'name_nb')

        # Deleting field 'HPhrase.name_nl'
        db.delete_column(u'chemicals_hphrase', 'name_nl')

        # Adding field 'HPhrase.description'
        db.add_column(u'chemicals_hphrase', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.description_en'
        db.add_column(u'chemicals_hphrase', 'description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.description_de'
        db.add_column(u'chemicals_hphrase', 'description_de',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.description_nl'
        db.add_column(u'chemicals_hphrase', 'description_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.description_nb'
        db.add_column(u'chemicals_hphrase', 'description_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PPhrase.name_de'
        db.delete_column(u'chemicals_pphrase', 'name_de')

        # Deleting field 'PPhrase.phrase'
        db.delete_column(u'chemicals_pphrase', 'phrase')

        # Deleting field 'PPhrase.name_en'
        db.delete_column(u'chemicals_pphrase', 'name_en')

        # Deleting field 'PPhrase.name_nb'
        db.delete_column(u'chemicals_pphrase', 'name_nb')

        # Deleting field 'PPhrase.name_nl'
        db.delete_column(u'chemicals_pphrase', 'name_nl')

        # Adding field 'PPhrase.description'
        db.add_column(u'chemicals_pphrase', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPhrase.description_en'
        db.add_column(u'chemicals_pphrase', 'description_en',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPhrase.description_de'
        db.add_column(u'chemicals_pphrase', 'description_de',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPhrase.description_nl'
        db.add_column(u'chemicals_pphrase', 'description_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPhrase.description_nb'
        db.add_column(u'chemicals_pphrase', 'description_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=400, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RPhrase.name_de'
        db.add_column(u'chemicals_rphrase', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RPhrase.phrase'
        db.add_column(u'chemicals_rphrase', 'phrase',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)

        # Adding field 'RPhrase.name_en'
        db.add_column(u'chemicals_rphrase', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RPhrase.name_nb'
        db.add_column(u'chemicals_rphrase', 'name_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RPhrase.name_nl'
        db.add_column(u'chemicals_rphrase', 'name_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'RPhrase.description'
        db.delete_column(u'chemicals_rphrase', 'description')

        # Deleting field 'RPhrase.description_en'
        db.delete_column(u'chemicals_rphrase', 'description_en')

        # Deleting field 'RPhrase.description_de'
        db.delete_column(u'chemicals_rphrase', 'description_de')

        # Deleting field 'RPhrase.description_nl'
        db.delete_column(u'chemicals_rphrase', 'description_nl')

        # Deleting field 'RPhrase.description_nb'
        db.delete_column(u'chemicals_rphrase', 'description_nb')

        # Adding field 'HPhrase.name_de'
        db.add_column(u'chemicals_hphrase', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.phrase'
        db.add_column(u'chemicals_hphrase', 'phrase',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)

        # Adding field 'HPhrase.name_en'
        db.add_column(u'chemicals_hphrase', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.name_nb'
        db.add_column(u'chemicals_hphrase', 'name_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HPhrase.name_nl'
        db.add_column(u'chemicals_hphrase', 'name_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HPhrase.description'
        db.delete_column(u'chemicals_hphrase', 'description')

        # Deleting field 'HPhrase.description_en'
        db.delete_column(u'chemicals_hphrase', 'description_en')

        # Deleting field 'HPhrase.description_de'
        db.delete_column(u'chemicals_hphrase', 'description_de')

        # Deleting field 'HPhrase.description_nl'
        db.delete_column(u'chemicals_hphrase', 'description_nl')

        # Deleting field 'HPhrase.description_nb'
        db.delete_column(u'chemicals_hphrase', 'description_nb')

        # Adding field 'PPhrase.name_de'
        db.add_column(u'chemicals_pphrase', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPhrase.phrase'
        db.add_column(u'chemicals_pphrase', 'phrase',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)

        # Adding field 'PPhrase.name_en'
        db.add_column(u'chemicals_pphrase', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPhrase.name_nb'
        db.add_column(u'chemicals_pphrase', 'name_nb',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PPhrase.name_nl'
        db.add_column(u'chemicals_pphrase', 'name_nl',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PPhrase.description'
        db.delete_column(u'chemicals_pphrase', 'description')

        # Deleting field 'PPhrase.description_en'
        db.delete_column(u'chemicals_pphrase', 'description_en')

        # Deleting field 'PPhrase.description_de'
        db.delete_column(u'chemicals_pphrase', 'description_de')

        # Deleting field 'PPhrase.description_nl'
        db.delete_column(u'chemicals_pphrase', 'description_nl')

        # Deleting field 'PPhrase.description_nb'
        db.delete_column(u'chemicals_pphrase', 'description_nb')
